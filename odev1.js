...
/*
let saniyeString = prompt("Saniye Değerini Giriniz", "100"); // , "100" Varsayılan Bir Değer
let saniye = parseInt(saniyeString); // parseInt Fonksiyonu Değişkeni İntager Veri Tipine Çevirmek İçin Kullanılıyor
...
console.log("Girdiğiniz " + girilenDerece+ " fahrenheit sıcaklık " + celciusDerece.toFixed(2)+" derecedir"); // toFixed() Fonksiyonu Virgülden Sonra Kaç Adet Rakam İstediğimizi Sorar
*/
